    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/admin/focus-groups" element={
            <ProtectedRoute allowedRoles={['admin']}>
              <AdminFocusGroups />
            </ProtectedRoute>
          } />
          ...
          <Route path="/client/create-group" element={
            <ProtectedRoute allowedRoles={['client']}>
              <CreateFocusGroup />
            </ProtectedRoute>
          } />
          ...
          <Route path="/participant/groups/:groupId" element={
            <ProtectedRoute allowedRoles={['participant']}>
              <ParticipantFocusGroupDetail />
            </ProtectedRoute>
          } />
          <Route path="/participant/questionnaire/:groupId" element={
            <ProtectedRoute allowedRoles={['participant']}>
              <ParticipantQuestionnaire />
            </ProtectedRoute>
          } />
          <Route path="/participant/completion/:groupId" element={
            <ProtectedRoute allowedRoles={['participant']}>
